...
object Watermarks {
  ...
  def testWatermark() = {
    ...
    /*
      ...
      - an element/a row/a record will be considered if ALTER the watermark
     */
...
object DataSender {
  ...
  val socket = serverSocket.accept()  // blocking all
  ...
  def example1() = {
    ...
    Thread.sleep(3000)
    printer.println("4000,purple") // excepted to be dropped - it's older than the watermark
    Thread.sleep(2000)
